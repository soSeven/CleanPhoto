...
open class PasswordContainerView: UIView {
    ...
    open var touchAuthenticationReason = "用于打开私密空间"
...
//        }
//    }
    fileprivate let kDefaultWidth: CGFloat = 70 + 66*3//288
    ...
    open override func awakeFromNib() {
        ...
        deleteButton.setTitleColor(.init(hex: "#666666"), for: .normal)
        deleteButton.titleLabel?.font = .init(style: .regular, size: 17)
    ...
    open override func layoutSubviews() {
        ...
        deleteButton.cornerRadius = 66/2.0
    }
