...
open class PasswordInputView: UIView {
    ...
    open var labelFont = UIFont(style: .regular, size: 32)
...
//    }
    ...
    @IBInspectable
    open var circleBackgroundColor = UIColor.init(hex: "#F2F2F2") {
        didSet {
    ...
    @IBInspectable
    open var textColor = UIColor.init(hex: "#4D4D4D") {
        didSet {
    ...
    @IBInspectable
    open var highlightBackgroundColor = UIColor.init(hex: "#009CFF")
